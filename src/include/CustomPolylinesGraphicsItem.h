...
template <typename P>
class CustomPolylinesGraphicsItem : public GraphicsItem
{
...
public:
  CustomPolylinesGraphicsItem(P* p_);
...
template <typename P>
CustomPolylinesGraphicsItem<P>::CustomPolylinesGraphicsItem(P * p_)
...
template <typename P>
QRectF 
CustomPolylinesGraphicsItem<P>::boundingRect() const
{
...
template <typename P>
void 
CustomPolylinesGraphicsItem<P>::paint(QPainter *painter, 
...
template <typename P>
void 
CustomPolylinesGraphicsItem<P>::updateBoundingBox()
{
...
template <typename P>
void 
CustomPolylinesGraphicsItem<P>::modelChanged()
{
  updateBoundingBox();
  update();
}
