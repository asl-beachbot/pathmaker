...
PointList PostProcessor::round_corner(ThreePointElem * el) {
...
PointList PostProcessor::round_outer_corner(ThreePointElem * el) {
...
PointList PostProcessor::decide_action(const Point_2 & p1, const Point_2 & p2, const Point_2 & p3, bool * outer, bool filling_element) {
